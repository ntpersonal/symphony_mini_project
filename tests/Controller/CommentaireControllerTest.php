...
class CommentaireControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'commentaire[listeCommentairesP]' => 'Testing',
            'commentaire[listeCommentairesPe]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setListeCommentairesP('My Title');
        $fixture->setListeCommentairesPe('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'commentaire[listeCommentairesP]' => 'Something New',
            'commentaire[listeCommentairesPe]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getListeCommentairesP());
        self::assertSame('Something New', $fixture[0]->getListeCommentairesPe());
    }
